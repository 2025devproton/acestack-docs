...
Esta sección incluye distintos apartados útiles para el entendimiento y configuración de los distintos módulos que incluye el bloque del Backend, con un especial foco en el Orquestrador.

<div class="grid cards" markdown>

-   :lucide-book:{ .lg .middle } __Explicación Técnica__
